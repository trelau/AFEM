...
# -*- coding: utf-8 -*-
#
# AFEM documentation build configuration file, created by
...
import os
import sys
sys.path.insert(0, os.path.abspath('.').rstrip('/docs/source'))
...
man_pages = [
    (master_doc, 'index', 'AFEM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AFEM', 'AFEM Documentation',
     author, 'AFEM', 'Airframe Finite Element Modeler.',
     'Engineering'),
]
